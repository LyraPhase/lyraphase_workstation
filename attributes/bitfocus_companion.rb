...
when 'arm64'
  Chef::Log.warn("lyraphase_workstation::bitfocus_companion: Detected arm64! Using Apple Silicon compatible installer")
...
when 'x86_64'
  Chef::Log.warn("lyraphase_workstation::bitfocus_companion: Detected x86_64! Using Intel Mac compatible installer")
